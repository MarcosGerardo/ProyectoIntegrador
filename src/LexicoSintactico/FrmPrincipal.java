...
File archivo = new File("archivo.txt");
       ...
       try {
            ...
            Logger.getLogger(Lexico.FrmPrincipal.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        try {
            Reader lector = new BufferedReader(new FileReader("archivo.txt"));
            LexicoSintactico.Lexer lexer = new LexicoSintactico.Lexer(lector);
            String resultado = "";
            while (true) {
                LexicoSintactico.Tokens tokens = lexer.yylex();
                if (tokens == null) {
                    resultado += "FIN";
